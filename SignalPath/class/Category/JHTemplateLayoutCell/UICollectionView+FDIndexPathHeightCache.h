//
//  UICollectionView+FDIndexPathHeightCache.h
//  holimoo
//
...
@interface UICollectionView (FDIndexPathHeightCache)
...
@interface UICollectionView (FDIndexPathHeightCacheInvalidation)
