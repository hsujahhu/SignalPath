...
- (NSIndexPath *)indexPathForItemClosestToPoint:(CGPoint)point
{
    ...
    UICollectionViewLayoutAttributes *currentAttr;
    ...
    for (UICollectionViewLayoutAttributes *layoutAttr in layoutAttrsInRect) {
        ...
        if (dist < closestDist) {
            ...
            currentAttr = layoutAttr;
        }
    }
    
    if ([currentAttr.representedElementKind isEqualToString:UICollectionElementKindSectionHeader] ||
        [currentAttr.representedElementKind isEqualToString:UICollectionElementKindSectionFooter]) {
        return nil;
    }
